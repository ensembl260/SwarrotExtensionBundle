...
use Ensembl260\SwarrotExtensionBundle\Rabbitmq\Specification\DeadLetterExchangeCanBeCreated;
use Ensembl260\SwarrotExtensionBundle\Rabbitmq\Specification\DelayExchangeCanBeCreated;
use Ensembl260\SwarrotExtensionBundle\Rabbitmq\Specification\RetryExchangeCanBeCreated;
    ...
    private function createQueues(Configuration $config): void
    {
        ...
        foreach ($config['queues'] as $name => $parameters) {
            ...
            foreach ($bindings as $binding) {
                if (!\is_array($binding) && str_contains($binding, ':')) {
